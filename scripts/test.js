...
async function run() {
  ...
  check('auth icons use aligned input action styling', html.includes('.auth-input-wrap{position:relative;') && html.includes('right:13px;top:50%;transform:translateY(-50%)') && html.includes('#subj-modal-footer{display:flex;flex-wrap:wrap'));
