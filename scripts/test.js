...
async function run() {
  ...
  check('auth screen gates the app before session', html.includes('<body class="auth-required">') && html.includes('id="auth-screen"') && html.includes('id="auth-form"') && html.includes('data-auth-mode="signup"') && html.includes('id="side-logout"'));
  check('professional signup fields exist', html.includes('id="auth-name"') && html.includes('id="auth-password-confirm"') && html.includes('id="auth-study-goal"') && html.includes('id="auth-terms"') && html.includes('Comece sua jornada'));
  ...
  check('Supabase profile flow stores display name and goal', script.includes('study_goal') && script.includes('DataStoreSupabase.profiles.upsert') && script.includes('DataStoreSupabase.profiles.getCurrent') && script.includes('DataStoreLocal.settings.saveProfile') && script.includes('password !== passwordConfirm') && script.includes('auth-terms'));
