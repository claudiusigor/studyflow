...
async function run() {
  ...
  check('official subjects recover from empty storage', script.includes("localStorage.getItem('sf_seeded_empty_v2') && AppDB.getSubjects().length") && script.includes('sf_reset_pmmg_done_v6'));
